...
public class MatrixActivity extends Activity {
    ...
    int procesoenejecucion;											//variable para especificar la fila actual en ejecuci�n

    Integer filas;													//numero de filas
    Integer columnasmatriz;											//numero de columnas
    
    Toast procesoejec;												//Toast para desplegar el proceso en ejecuci�n
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        asignar = (Button) findViewById(R.id.button2);				//boton para asignar valores ingresados a las matrices con las que operar�
    ...
    //iniciar recorrido para la creaci�n de la matriz de recursos asignados
    ...
    //Creaci�n de la matriz de recursos maximos
    for (int i = 0; i < filas; i++) {
    	
        TableRow row = new TableRow(this);								//creaci�n de fila
    	...
    	//boton.setEnabled(false);										//deshabiliar bot�n de generaci�n de matrices para operar solo con los datos de recursos y procesos inicialmente ingresados
    ...
    public void asignarvalores(){
    	...
    	banderaexe=true;												//reasignaci�n de valor para la bandera que controla la existencia de recursos
    	...
    	//en caso de que no haya alg�n dato en el vector no se puede iniciar las operaciones
    	if(banderaexe==false){
    	...
    	//en caso de que el valor de la bandera de ejecuci�n sea cierto, esto indica que se pueden iniciar las operaciones
    	else{ 
    	...
    	maximos = new int[filas][columnasmatriz];						//Matriz de recursos m�ximos requeridos
        ...
        for (int i = 0; i < filas; i++) {
        	for (int j = 0; j < columnasmatriz; j++) {
            	...
            	System.out.println(maximos[i][j]);							//Punto de cotrol. Mostrar en consola datos de la matriz de m�ximos requeridos
                
            }
            	
        }
        
        //reiniciar valores de indices en caso de una nueva ejecuci�n
        indice=0;
       ...
       //asignar valor cero a las celdas contenidas en el vector de recursos disponibles -se puede mover arriba-
        ...
        for (int i = 0; i < filas; i++) {
        	...
        	//verificar si la fila est� marcada como ejecutada
        	if((asignados[i][0])== -1){
            ...
            for (int j = 0; j < columnasmatriz; j++) {
            	...
            	//verficar si la suma es mayor o igual al m�ximo de recursos necesarios
            ...
            //y no se alter� la bandera, por tanto el proceso se puede ejecutar
            if(banderamayor==true){
            	
            	String procesoejecutado= "Proceso En ejecuci�n P"+procesoenejecucion;      //Crear string de mensaje que indica la fila o proceso con resultados satisfactorios
            	...
            	System.out.println("proceso en ejecucion "+procesoenejecucion); 			//punto de control. Verificar en consola fila en ejecuci�n
            	...
            	for (int a=0;a<filaschequeadas.size();a++){
            		...
            		if(filaschequeadas.get(a).getId()==procesoenejecucion){
            			...
            			//table.removeView(filaschequeadas.get(a));							//segunda opci�n:remover filas que hacen referencia a procesos ejecutados
            			...
            			Internamente la fila est� marcada en la matr�z como ejecutada por lo que no se toca*/
    ...
    //verificar si hubo un resultado que no fue mayor al maximo, por lo que la bandera no se modific�. Esto indica un estado no seguro
   ...
   }//cierre del else en caso de que hayan elementos o procesos en ejecuci�n   
